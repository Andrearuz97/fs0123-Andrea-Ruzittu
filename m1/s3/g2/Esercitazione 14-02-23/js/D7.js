...
*/
function concatenaStringhe(prima, seconda){
prima = prima.substring(0, 2);
seconda = seconda.slice(-3);
return prima.toUpperCase() + seconda.toUpperCase();
} 
console.log(concatenaStringhe("roma", "napoli"));
 ...
 */
  ...
  console.log(sommaCatena([1,2,6,3,8,10,57,87,35,22])) 
...
console.log(incrementa([1,2,6,3,8,10,57,87,35,22])) 
/* ESERCIZIO 8
  Sostituisci ogni stringa contenuta in un array con un numero rappresentante la sua lunghezza.
  es.: ["EPICODE", "is", "great"] => [7, 2, 5]
*/
let array = ['EPICODE','is','great'];
function sostituisciLunghezza(array){
  for (let i = 0; i < array.length; i++) {
   array[i] = array[i].length; 
  }
  return array;
}
console.log(sostituisciLunghezza(["EPICODE", "is", "great"]));
/* ESERCIZIO 9 (EXTRA)
